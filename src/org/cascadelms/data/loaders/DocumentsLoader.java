...
public class DocumentsLoader extends AsyncTaskLoader<List<Document>>
{
     ...
     *
     * @param context  the Context where this loader will be used.
     * @param source   a DocumentsDataSource to provide the data
     * @param courseId the database id of a Course
     * @param folder   an optional
     */
